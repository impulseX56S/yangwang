...
ID_LABEL = {
    'mia':      {'label': '米娅',   'role': '辅助师',   'duty': '特殊任务处理',        'emoji': '👼'},
    'main':     {'label': '米娅',   'role': '辅助师',   'duty': '特殊任务处理',        'emoji': '👼'},  # 兼容旧配置
    'fiona':    {'label': '菲奥娜', 'role': '策略师',   'duty': '方案规划与策略制定',  'emoji': '📝'},
    'sakura':   {'label': '樱雪',   'role': '侦察员',   'duty': '审核与风险评估',      'emoji': '🐱'},
    'aria':     {'label': '艾莉亚', 'role': '副团长',   'duty': '总协调与任务监督',    'emoji': '🌟'},
    'lena':     {'label': '莉娜',   'role': '团队管理师', 'duty': '人事与组织管理',     'emoji': '👥'},
    'luna':     {'label': '露娜',   'role': '财务师',   'duty': '财务与资源管理',      'emoji': '💎'},
    'seria':    {'label': '瑟莉亚', 'role': '守护者',   'duty': '安全与应急响应',      'emoji': '🛡️'},
    'elsa':     {'label': '艾尔莎', 'role': '守护者',   'duty': '规范与质量审查',      'emoji': '⚖️'},
    'melissa':  {'label': '梅丽莎', 'role': '工匠师',   'duty': '工程与技术实施',      'emoji': '⚙️'},
    'nicole':   {'label': '妮可',   'role': '招募师',   'duty': '人事招聘与培训',      'emoji': '🦊'},
    'verity':   {'label': '薇尔莉特', 'role': '祈愿师', 'duty': '冒险任务召集与议程管理', 'emoji': '✨'},
}
...
def main():
    ...
    EXTRA_AGENTS = {
        'mia':      {'model': default_model, 'workspace': str(pathlib.Path.home() / '.openclaw/workspace-mia'),
                    'allowAgents': ['fiona']},
        'main':     {'model': default_model, 'workspace': str(pathlib.Path.home() / '.openclaw/workspace-main'),
                    'allowAgents': ['fiona','sakura','aria','luna','lena','seria','elsa','melissa','nicole']},
        'verity':   {'model': default_model, 'workspace': str(pathlib.Path.home() / '.openclaw/workspace-verity'),
                    'allowAgents': []},
        'nicole':   {'model': default_model, 'workspace': str(pathlib.Path.home() / '.openclaw/workspace-nicole'),
                    'allowAgents': ['aria']},
    }
